                    ...
                    children: [
                      ...
                      Align(
                       ...
                       Align(
                        ...
                        child: Container(
                          child: Text(
                           NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(_currentPrestamoValue.round()),
                      ...
                      SizedBox( height: 20 ),
                       ...
                       Align(
                        ...
                        child: Container(
                          child: Text(
                            NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(_currentPagoValue.round())+ " por Semana",
                             style: TextStyle( fontSize: 16, color: Colors.blueAccent )
                          ),
                        ),
                      ),
                      ...
                      MaterialButton(
                        ...
                        onPressed: () async {
                          ...
                          await storage.write(key: 'prestamo', value: _currentPrestamoValue.toString());
                          await storage.write(key: 'pago', value: _currentPagoValue.toString());
                          await storage.write(key: 'fecha_prestamo', value: _currentFechaValue.toString());

                          Navigator.push(context, new MaterialPageRoute(
                            builder: (context) => new ResumenSimuladorPage())
                          );
                        }
                      ),
