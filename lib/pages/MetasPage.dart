            ...
            child: ListTile(
                title: Text(
                    NumberFormat.simpleCurrency(
                        ...
                        .format(double.parse(data[index]['meta'])),
                    style: TextStyle(fontSize: 17, color: Colors.yellow[700])),
                subtitle:
                    Text("Meta", style: TextStyle(color: Colors.yellow[700])),
                leading: Image.asset('asset/images/ic_empty_goals.png',
                    width: 100.0),
          ...
          return Card(
            ...
            child: ListTile(
                title: Text(
                    NumberFormat.simpleCurrency(
                            locale: 'es_419', decimalDigits: 2)
                        .format(double.parse(data[index]['prestamo'])),
                    style: TextStyle(fontSize: 17, color: Colors.blueAccent)),
                subtitle: Text("Prestamo",
                    style: TextStyle(color: Colors.blueAccent)),
                leading:
                    Image.asset('asset/images/ic_balance.png', width: 100.0),
                trailing: Icon(Icons.keyboard_arrow_right),
                onTap: () => {
                      _showModalBottomSheet(
                          context, "Prestamo", data[index]['id'])
                    }),
          );
        });
  }
