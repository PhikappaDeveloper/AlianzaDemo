...
class prestamo {
  ...
  static Future<int> createItem(
      String? prestamos, String? pago, String? fecha) async {
  ...
  static Future<int> updateItem(
      int id, String prestamos, String? pago, String? fecha) async {
    final db = await prestamo.db();

    final data = {'prestamo': prestamos, 'pago': pago, 'fecha': fecha};

    final result =
        await db.update('prestamos', data, where: "id = ?", whereArgs: [id]);
