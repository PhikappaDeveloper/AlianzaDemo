                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Container(
                          child: Text(
                            "¿Cual es su meta total de ahorro?",
                             style: TextStyle( fontSize: 16, color: Colors.black87 )
                          ),
                        ),
                      ),
                      ...
                      SizedBox( height: 10 ),
                       ...
                       Align(
                        ...
                        child: Container(
                          child: Text(
                             NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(_currentMetaValue.round()),
                      ...
                      Slider(
                        ...
                        onChanged: (double value) {
                          setState(() {
                            ...
                            int diff = value ~/  double.parse(ahorroController.text);
                            
                             var semana = now.add( Duration(days: diff * 7));
                             _currentFechaValue = DateFormat.yMMMMd('es').format(semana);
                          });
                        },
                      ),
                      SizedBox( height: 20 ),
                       ...
                       Align(
                        ...
                        child: Container(
                          child: Text(
                            '¿Cuanto puedes ahorrar a la semana?',
                             style: TextStyle( fontSize: 16, color: Colors.black87 )
                          ),
                        ),
                      ),
                    ...
                    Focus(
                      child:TextFormField(
                        ...
                        onFocusChange: (hasFocus) {
                            ...
                            if(!hasFocus){
                              setState(() {
                                int diff = _currentMetaValue ~/  double.parse(ahorroController.text);
                      ...
                      MaterialButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            await storage.write(key: 'meta', value: _currentMetaValue.toString());
                            await storage.write(key: 'ahorro', value: ahorroController.text);
                            await storage.write(key: 'fecha', value: _currentFechaValue.toString());

                            Navigator.push(context, new MaterialPageRoute(
                              builder: (context) =>  new ResumenCalculadoraPage())
                            );
