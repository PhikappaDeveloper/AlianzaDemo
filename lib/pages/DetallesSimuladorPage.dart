                    ...
                    children: [
                      ...
                      Align(
                       ...
                       Align(
                        ...
                        child: Container(
                          child:Text(
                              NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(double.parse(data[0]['prestamo'])),
                      ...
                      Align(
                        ...
                        child: Container(
                          child:Text(
                              NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(double.parse(data[0]['pago'])),
                              style: TextStyle( fontSize: 16, color: Colors.yellow[700] )
                          )
                        ),
                      ),
