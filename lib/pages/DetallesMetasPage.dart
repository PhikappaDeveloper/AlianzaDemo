...
class DetallesMetasPage extends StatelessWidget {
  ...
  Widget _DetallesWidget(BuildContext context, List<Map<String, dynamic>> data){
                    ...
                    children: [
                      ...
                      Align(
                       ...
                       Align(
                        ...
                        child: Container(
                          child:Text(
                              NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(double.parse(data[0]['meta'])),
                      ...
                      Align(
                        ...
                        child: Container(
                          child:Text(
                              NumberFormat.simpleCurrency(locale: 'es_419',decimalDigits: 2).format(double.parse(data[0]['ahorro'])),
                              style: TextStyle( fontSize: 16, color: Colors.yellow[700] )
                          )
                        ),
                      ),
